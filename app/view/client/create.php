...
<section class="form-wrapper" aria-label="Formulaire de création client">
    ...
    <form action="?action=client-create" method="POST">
        ...
        <!-- Champ adresse -->
        <label>Adresse</label>
        <input type="text" name="address" placeholder="rue Winston Churchill" required>
        ...
        <input type="text" name="zipCode" placeholder="56000" required>
        ...
        <!-- Champ adresse -->
        <label>Ville</label>
        <input type="text" name="city" placeholder="Vannes" required>
